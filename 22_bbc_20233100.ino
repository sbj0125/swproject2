...
#define _DUTY_MAX 2537 // 2000
#define _DUTY_NEU 1368 // 1500
#define _DUTY_MIN 594 // 1000

#define _SERVO_ANGLE_DIFF  101.7  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return (593 + (-2.03)*pow(a_value,1) + (1.74)*pow(10,-3)*pow(a_value,2)); //593 + -2.03x + 1.74E-03x^2
}
